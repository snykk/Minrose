        ...
        <div class="panel-body mt-3">
            <div class="row">
                ...
                <div class="col-md-11">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-right"><label class="badge bg-danger">ditolak</label></div>
                            <span><strong>Minrose Cup</strong></span> <span class="badge bg-primary">COD</span><br />
                            Kuantitas : 2, Total harga: Rp. 20.000 <br />
                            <small>Catatan: sedang menunggu pertemuan COD</small><br>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-11">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-right"><label class="badge bg-warning">pending</label></div>
                            ...
                            <small>Catatan: [belum ada bukti transfer] sedang menunggu pengiriman bukti transaksi</small><br>
            ...
            <div class="row">
                <div class="col-md-1">
                    <img src="<?= base_url("assets/img/produk/minrose-dus.jpg")?>" class="media-object  img-thumbnail" />
                    <div class="detail-pemesanan"><a data-bs-toggle="modal" data-bs-target="#ModalDetailDataPemesanan" title="detail pemesanan" style="cursor: pointer;">detail</a></div>
                </div>
                <div class="col-md-11">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-right"><label class="badge bg-success">disetujui</label></div>
                            <span><strong>Minrose Dus</strong></span> <span class="badge bg-primary">COD</span><br />
                            Kuantitas : 4, Total harga: Rp. 15.000<br />
                            <small>Catatan: sedang menunggu pertemuan COD</small><br>
                        </div>
                        <div class="col-md-12">pesanan dibuat pada: 06/20/2022 oleh <a href="#">@iya ini pen ngubah aja</a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-1">
                    <img src="<?= base_url("assets/img/produk/minrose-botol.jpg")?>" class="media-object img-thumbnail" />
                    <div class="detail-pemesanan"><a data-bs-toggle="modal" data-bs-target="#ModalDetailDataPemesanan" title="detail pemesanan" style="cursor: pointer;">detail</a></div>
                </div>
                <div class="col-md-11">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-right"><label class="badge bg-success">disetujui</label></div>
                            <span><strong>Minrose Botol </strong></span><span class="badge bg-primary">COD</span><br />
                            Kuantitas : 4, Total harga: Rp. 25.000<br />
                            <small>Catatan: sedang menunggu pertemuan COD</small><br>
                        </div>
                        <div class="col-md-12">pesanan dibuat pada: 06/20/2022 oleh <a href="#">@iya ini pen ngubah aja</a></div>
                    </div>
