      ...
      <div class="col-lg-9">
        ...
        <div class="accordion-item mb-3 px-4 py-3">
          <div class="row mb-3">
            <div class="col-8">
              <div class="form-group">
                ...
                <input type="hidden" name="id" value="<?= set_value('nama', $produk["id"]); ?>">
              </div>
            </div>
            <div class="col-4">
              <div class="form-group">
          ...
          <div class="form-group mb-3 col-2">
            ...
            <input id="jumlah_produk" name="jumlah_produk" value="<?= set_value('jumlah_produk', "0"); ?>" type="number" min="0" max="<?= $produk["stok"];?>" class="form-control" onchange="myCounter()" required>
            <?= form_error('jumlah_produk', '<small class="text-danger pl-3">', '</small>'); ?>
          </div>
          <div class="form-group mb-3">
            <label for="alamat">Alamat Pelanggan</label>
            <input id="alamat" name="alamat" value="<?= set_value('alamat', $user["alamat"]); ?>" type="text" class="form-control" required>
          ...
          <div class="accordion-item mb-3 ">
            <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
              <div class="form-check w-100 collapsed">
                <input class="form-check-input" type="radio" name="online_bank" id="online_bank" data-bs-toggle="collapse" data-bs-target="#collapseCC" aria-expanded="false">
            ...
            <div id="collapseCC" class="accordion-collapse collapse fade" data-bs-parent="#accordionMain">
              <div class="accordion-body">
                ...
                <div id="mandiri" class="form-check w-100 collapsed">
                  ...
                  <input type="radio" id="bank_mandiri" class="bank" name="bank" value="bank_mandiri" style="appearance: none;">
                  ...
                  <div id="section_mandiri" class="accordion-collapse collapse fade collapse-pilih-bank" data-bs-parent="#collapseCC">
                    <!-- collapse pilih bank -->
                ...
                <div id="bri" class="form-check w-100 collapsed">
                  ...
                  <input type="radio" id="bank_bri" class="bank" name="bank" value="bank_bri" style="appearance: none;">
                ...
                <div id="bca" class="form-check w-100 collapsed" >
                  ...
                  <input type="radio" id="bank_bca" class="bank" name="bank" value="bank_bca" style="appearance: none;">
                ...
                <div id="bni" class="form-check w-100 collapsed" >
                  ...
                  <input type="radio" id="bank_bni" class="bank" name="bank" value="bank_bni" style="appearance: none;">
          ...
          <div class="accordion-item mb-3 border">
            <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
              <div class="form-check w-100 collapsed" >
                <input class="form-check-input" type="radio" name="online_bank" id="cod" data-bs-toggle="collapse" data-bs-target="#collapsePP" aria-expanded="false">
