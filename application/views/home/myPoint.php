        ...
        <div id="content">
            <div class="container-fluid mt-5">
                <div class="text-center">
                    ...
                    <a type="submit" id="ambil_point" class="btn btn-success text-white mt-5" data-validKah="<?= $user['point'] >= 150 ? 'true' : 'false' ?>" href="<?= base_url("home/ambilPoint"); ?>">Konversi point ke kupon</a>
